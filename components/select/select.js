...
var SelectComponent = /** @class */ (function () {
    function SelectComponent(element, http, emitter, cd) {
        var _this = this;
        this.http = http;
        ...
        this.emitterSubscription = this.emitter.notification.subscribe(function (opened) {
            if (opened !== _this) {
    ...
    SelectComponent.prototype.onDragStart = function (event) {
    ...
    SelectComponent.propDecorators = {
        ...
        "noResultsText": [{ type: core_1.Input },],
